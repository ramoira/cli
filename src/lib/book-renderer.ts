...
<!-- WATERMARK -->
<div class="watermark">
  Generated by <a href="https://github.com/ramoira/cli" target="_blank">Ramoira</a> — the open brand operating system.${schemaPath ? ` &nbsp;·&nbsp; <a href="${escHtml(schemaPath)}" target="_blank">View schema</a>` : ""}<br>
  If you love this tool, please consider <a href="https://github.com/ramoira/cli" target="_blank">giving us a star on GitHub</a>!
</div>
